...
- Cursor session history for intent and rationale.
...
9. Append a `Co-authored-by` trailer for Cursor using `Cursor <cursor@openai.com>`
...
Co-authored-by: Cursor <cursor@openai.com>
```
