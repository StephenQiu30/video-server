...
- [代码质量问题与修复登记](code-quality.md)：跨 Server/Web/App 的首轮缺陷、重复规则与设计复杂度裁决；逐项修复和验收，当前未实施修复，不代表已完成全仓审计。
- 平台访问与会话恢复：[035 设计](design/035-平台访问与会话恢复能力设计.md) · [需求](prd/035-平台访问与会话恢复能力需求.md) · [计划](plans/035-平台访问与会话恢复能力计划.md) · [验收](acceptance/035-平台访问与会话恢复能力验收.md)。**仅设计、待评审；可行性实验与实现均未获批准**。GitHub 依据见 [020 调研](research/020-平台会话生命周期与跨机器恢复调研.md)。
...
| 035 | 平台访问策略、会话生命周期与跨机器恢复；仅设计待评审 | [Design](design/035-平台访问与会话恢复能力设计.md) | [PRD](prd/035-平台访问与会话恢复能力需求.md) | [Plan](plans/035-平台访问与会话恢复能力计划.md) | [Acceptance](acceptance/035-平台访问与会话恢复能力验收.md) |
