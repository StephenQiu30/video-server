...
- 关联设计：`docs/design/010-Codex与Claude CLI视频分析设计.md`、`docs/archive/012/012-AI分析报告与MinIO持久化设计.md`、`docs/archive/014/014-WebSocket任务状态同步设计.md`、`docs/archive/015/015-RabbitMQ异步分析设计.md`
