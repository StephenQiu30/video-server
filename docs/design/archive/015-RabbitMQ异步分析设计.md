...
- 关联设计：`docs/design/010-Codex与Claude CLI视频分析设计.md`、`docs/design/archive/012-AI分析报告与MinIO持久化设计.md`、`docs/design/archive/013-AI分析原任务重试设计.md`、`docs/design/archive/014-WebSocket任务状态同步设计.md`
