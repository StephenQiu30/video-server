...
import merge from '/Users/stephenqiu/Desktop/StephenQiu30/Video/apps/web/node_modules/lodash/merge'
...
const getAntdConfig = () => {
  if(!cacheAntdConfig){
    cacheAntdConfig = getPluginManager().applyPlugins({
      ...
      initialValue: {
        ...{"theme":{"token":{"borderRadius":6,"colorPrimary":"#1677ff","colorInfo":"#1677ff"}}},
      },
    });
