...
from app.repositories.analysis_report_lifecycle import AnalysisReportLifecycleRepository
from app.repositories.analysis_report_state import lock_report_and_job
