from app.repositories.analysis.storage_fields import integer, mapping, string, strings
from app.services.analysis.rules.result_items import Highlight, Shot, VisualAsset
from app.services.analysis.rules.result_models import ProductionAdvice
