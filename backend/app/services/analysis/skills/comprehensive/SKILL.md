...
metadata:
  ...
  video-server-default-prompt: 完整覆盖视频并区分真实编辑边界与连续视觉节拍，建立“分镜事实—段落结构—高光与资产—制作策略”证据链，指出关键转折、连续性风险和优先行动。
...
1. 连续覆盖全片，先确认真实编辑边界，再识别连续长镜头内主体任务、空间区域、动作阶段、信息状态或构图任务的有意义重置；两者共同构成分析分镜时间线。
