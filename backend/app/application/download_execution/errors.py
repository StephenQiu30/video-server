...
_RUNNER_CODES = {
    ...
    "invalid_artifact_delivery": DownloadErrorCode.MEDIA_VALIDATION_FAILED,
    "artifact_delivery_rejected": DownloadErrorCode.MEDIA_VALIDATION_FAILED,
    "artifact_delivery_failed": DownloadErrorCode.STORAGE_UNAVAILABLE,
