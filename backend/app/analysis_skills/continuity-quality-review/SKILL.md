...
metadata:
  ...
  video-server-default-prompt: 以交付前看片方式完整审查成片，检查主体与资产状态、空间和运动方向、动作衔接、构图与图形一致性、画面文字可读性以及可见黑帧、闪烁、拉伸或遮挡问题。
...
1. 建立完整逐镜头与场景覆盖，比较相邻镜头的主体身份、服装/道具/界面状态、空间关系、屏幕方向、动作起止和光色规则。
