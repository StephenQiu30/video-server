...
报告当前状态；刷新失败保留最后一个有效快照。平台主动撤销、账号退出或验证挑战
仍会被明确报告，不能承诺绕过平台要求的重新登录。
