...
import pytest
from app.workers.runner.plugins.yt_dlp_plugins.extractor import xiaohongshu_availability
...
def test_translates_first_party_error_redirects(
    ...
    error = xiaohongshu_availability._availability_error(
...
def test_preserves_successful_first_party_response() -> None:
    assert (
        xiaohongshu_availability._availability_error(
