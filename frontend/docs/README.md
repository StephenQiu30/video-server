...
本目录维护万能视频下载器 MVP Web 的设计基线、需求、执行计划和验收证据。Ant Design Pro/Umi 实现已合并到 `main`；未通过的强验收项继续在活动 Acceptance 中跟踪。

## 当前文档

- [Design 索引](design/README.md)：4 份已确认基线，已归档到 `design/archive/`。
- [PRD 索引](prd/README.md)：4 份已确认需求，已归档到 `prd/archive/`。
- [Plan 索引](plans/README.md)：4 份均已实施；因 Acceptance 为 Blocked，暂留活动目录。
- [Acceptance 索引](acceptance/README.md)：4 份均已执行并保持 Blocked，继续补齐真实浏览器和服务端证据。
